  ...
  return function e(t, n, r) {
      ...
      if (typeof window === "object" && window.RTCPeerConnection && !("getSenders" in RTCPeerConnection.prototype) && "createDTMFSender" in RTCPeerConnection.prototype) {
        ...
        if (!RTCPeerConnection.prototype.addTrack) {
          RTCPeerConnection.prototype.addTrack = function(track, stream) {
            ...
            var sender = {track:track, get dtmf() {
    ...
    module.exports = function() {
      ...
      var shimError_ = function(e) {
        return {name:{ConstraintNotSatisfiedError:"OverconstrainedError", PermissionDeniedError:"NotAllowedError", TrackStartError:"NotReadableError"}[e.name] || e.name, message:e.message, constraint:e.constraintName, toString:function() {
    ...
    module.exports = function(edgeVersion) {
      ...
      RTCPeerConnection.prototype.addTrack = function(track, stream) {
        ...
        transceiver.rtpSender = new RTCRtpSender(track, transceiver.dtlsTransport);
        ...
        sections.forEach(function(mediaSection, sdpMLineIndex) {
          ...
          if (description.type === "offer" && !rejected) {
            ...
            if (direction === "sendrecv" || direction === "sendonly") {
              rtpReceiver = new RTCRtpReceiver(transceiver.dtlsTransport, kind);
      ...
      RTCPeerConnection.prototype.createOffer = function() {
        ...
        transceivers.forEach(function(transceiver, sdpMLineIndex) {
          ...
          if (transceiver.wantReceive) {
            transceiver.rtpReceiver = new RTCRtpReceiver(transceiver.dtlsTransport, kind);
          }
          transceiver.localCapabilities = localCapabilities;
          transceiver.sendEncodingParameters = sendEncodingParameters;
        });
    ...
    var safariShim = {shimAddStream:function() {
      if (typeof window === "object" && window.RTCPeerConnection && !("addStream" in window.RTCPeerConnection.prototype)) {
        RTCPeerConnection.prototype.addStream = function(stream) {
          var self = this;
          stream.getTracks().forEach(function(track) {
            self.addTrack(track, stream);
    ...
    module.exports = {shimCallbacksAPI:safariShim.shimCallbacksAPI, shimAddStream:safariShim.shimAddStream, shimOnAddStream:safariShim.shimOnAddStream, shimGetUserMedia:safariShim.shimGetUserMedia};
