...
TURN_SERVER_OVERRIDE = [
   {
     "urls": [
       "turn:10.112.178.193:3478?transport=udp",
       "turn:10.112.178.193:3478?transport=tcp"
     ],
     "username": "helloword",
   ...
   {
     "urls": [
       "stun:10.112.178.193:3478"
     ]
   }
 ]
# TODO(jansson): Remove once AppRTCDemo on iOS supports ICE_SERVER.
TURN_BASE_URL = 'https://apprtc.io'
TURN_URL_TEMPLATE = '%s/turn?username=%s&key=%s'
CEOD_KEY ='helloword'

#ICE_SERVER_BASE_URL = 'https://networktraversal.googleapis.com'
ICE_SERVER_BASE_URL = 'https://apprtc.io'
...
WSS_INSTANCE_HOST_KEY = '10.112.178.193:8089' 
